...
public class FullscreenAboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullscreen_about);
        ...
        findViewById(R.id.websiteButton).setOnTouchListener(mDelayHideTouchListener);
    }
    ...
    public void goToPotato (View view) {
        goToUrl ( "https://orixa.potato-corp.com/");
    }
